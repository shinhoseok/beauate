...
public interface PayDao {
	 ...
	 * @throws Exception
	 */ 
	List<PayVO> selectMentoPayUserList(PayVO payVO) throws Exception;
	
	/**
	 * <pre>
	 * 1. 개요 : 멘토페이지 결제한 사용자 리스트 카운트
	 * 2. 처리내용 :  멘토페이지 결제한 사용자 리스트 카운트
	 * </pre>
	 * @Method Name : selectMentoPayUserListCnt
	 * @date : 2019. 10. 16.
	 * @author : 뷰아떼1
	 * @history : 
	 *	-----------------------------------------------------------------------
	 ...
	 * @throws Exception
	 */ 
	Integer selectMentoPayUserListCnt(PayVO payVO) throws Exception;
}
