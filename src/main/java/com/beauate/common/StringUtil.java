...
public class StringUtil extends StringUtils{
	...
	public static String evl(String str, String defaultVal) {
		return StringUtils.isEmpty(str) ? defaultVal : str;
	}
	...
	/**
	 * 컬럼명 스타일의 문자열(대문자와 단어 사이의 구분은 Underbar)을 변수명 스타일의 문자열(camel-cased)로 바꾼다.
	 * @param columnNameString	COLUMN_NAME_STRING	
	 * @return	camelCasedString
	 * @author 이기춘
	 */
	public static String toCamelCaseName(String columnNameString) {
		return WordUtils.uncapitalize(WordUtils.capitalizeFully(
				columnNameString, "_".toCharArray()).replaceAll("_", ""));
	}
	 ...
	 *	모두 빈 문자열이인지 검사합니다. 
	 * @param targets	비교 대상
	 * @return 하나라도 비어있지 않으면 <code>false</code>
	 * @author 임준혁
	 */
	 ...
	 * @param targets
	 * @return 하나라도 비어있으면 <code>true</code>
	 * @author 김명래
	 */
