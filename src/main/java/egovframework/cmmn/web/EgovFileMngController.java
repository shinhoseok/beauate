...
public class EgovFileMngController {
    ...
    public String selectFileInfs(@ModelAttribute("fileVO") FileVO fileVO,
    ...
    public String deleteFileInf(@ModelAttribute("fileVO") FileVO fileVO,
		 ...
		 * "/".equals(request.getContextPath())) { return "forward:" +
		 * returnUrl; }
		 *
		 * if (returnUrl.startsWith(request.getContextPath())) { return
		 * "forward:" + returnUrl.substring(returnUrl.indexOf("/", 1)); } else {
		 * return "forward:" + returnUrl; }
		 */
        // //------------------------------------------
    }
