...
<div id="wrap" class="offline">
	...
	<div id="container">
		...
		<div class="content">
			...
			<!--//뷰티 type -->
			<c:if test="${fn:length(specialMentorList)>0}">
			<div class="besthair">
				<div class="content-inner">
				...
				<div class="besthair-list">
				 <!-- swiper -->
				  <div class="swiper-container">
					...
					<c:forEach var="specialMento" items="${specialMentorList}" begin="0" end="${fn:length(specialMentorList)-1}" varStatus="status">
					...
					<c:if test="${status.count!=fn:length(specialMentorList)}">
					  <div class="swiper-slide">
					    <ul class="product-list-02" data-column="4">
					</c:if>
					</c:when>
					<c:when test="${status.count mod 4!=0 and status.count==fn:length(specialMentorList)}">
					    </ul>
					  </div>
					</c:when>
					<c:otherwise>
