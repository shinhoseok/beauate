...
<div class="wrap">
	<div class="container">
		...
		<div class="contents">
			...
			<h4 class="contentTitle_h4">권한 그룹 정보 수정</h4>
			<form:form commandName="roleVO" method="post" id="updateForm">
							...
							<tr>
								...
								<td>
									<form:select path="rlCls" cssClass="w30p">
										<form:option value="U" label="인증된 사용자권한"/>
										<form:option value="A" label="관리자권한"/>
									</form:select>
								</td>
							</tr>
							<tr>
				...
				<div class="T_btnLayer fr">
					<a href="#"><button type="button" class="blueBtn L" onclick="fn_updateProc();">수정</button></a>
...
fn_cancel = function () {
	$("#updateForm").attr("action", "${basePath}/role/r/m/selectRoleGroupDetail.do").submit();
};

fn_updateProc = function () {
	$("#updateForm").attr("action", "${basePath}/role/w/n/updateRoleGroupProc.do").submit();
};
</script>
</body>
</html>