...
<body>
	...
	<div class="wrap">
		<div class="container">
			...
			<!-- left_menu End -->
			<div class="contents">
				<p class="contentTitle">후기관리 상세보기</p>
				<!-- sub_path Start -->
				<p class="sub_path">
					<p class="sub_path"><img src="${imagePath}/ico_home.png" width="10" height="9" />&nbsp;〉&nbsp;멘토&nbsp;〉&nbsp;후기 관리〉&nbsp;후기관리 상세보기</p>
				</p>
				<!-- sub_path End -->
				...
				<div class="T_btnLayer fr">
					...
					<a href="${basePath}/mento/r/n/selectOffClassReviewList.do"><button type="button" class="blueBtn L">목록</button></a>
				</div>
			</div>
		</div>
		<!--container End-->
	...
	var fn_insertCommentProc = function() {
		$('#commentVO').attr("action","${basePath }/mento/w/n/insertCommentMngProc.do");
		$('#commentVO').submit();
	};
	...
	var fn_updateCommentProc = function() {
		$('#commentVO').attr("action","${basePath }/mento/w/n/updateCommentProc.do");
		$('#commentVO').submit();
	};
	
	//댓글삭제
	var fn_deleteCommentProc = function() {
		$('#commentVO').attr("action","${basePath }/mento/w/n/deleteCommentProc.do");
		$('#commentVO').submit();
	};
	</script>
</body>
